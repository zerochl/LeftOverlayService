...
// */
//
//final class  BaseOverlayControllerBinder extends LauncherOverlayInterfaceBinder implements Runnable{
//    int mOptions = 0;
//    final String mPackageName;
//    private final BaseOverlaysController overlaysController;
...
//
//    public BaseOverlayControllerBinder(BaseOverlaysController overlaysControllerVar, int callerUid, String packageName, int serverVersion, int clientVersion) {
...
//    }
//
//    public final synchronized void windowAttached(WindowManager.LayoutParams layoutParams, d dVar, int clientOptions) {
